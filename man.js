...
if (hotDiv) {
  fetch('https://nguyenduong15032006-cell.github.io/db.json/')
...
if (productDetailDiv) {
  ...
  const id = urlParams.get('id');
    ...
    fetch(`https://nguyenduong15032006-cell.github.io/db.json/${id}`)
    .then(response => response.json())
    .then(data => {
      console.log(data);
      const product = new Product(
...
async function renderCart() {
  ...
  try {
    ...
    if (!Array.isArray(productsList)) {
      const res = await fetch('https://nguyenduong15032006-cell.github.io/db.json/');
...
async function saveProductFromForm() {
  ...
  try {
    if (id) {
      await fetch(`https://nguyenduong15032006-cell.github.io/db.json/${id}`, {
        method: 'PUT',
      ...
      await fetch('https://nguyenduong15032006-cell.github.io/db.json/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function deleteProduct(id) {
  ...
  try {
    await fetch(`https://nguyenduong15032006-cell.github.io/db.json/${id}`, { method: 'DELETE' });
...
async function loadAllProducts() {
  try {
    ...
    if (!Array.isArray(window.PRODUCT_CACHE.list)) {
      const response = await fetch('https://nguyenduong15032006-cell.github.io/db.json/');
